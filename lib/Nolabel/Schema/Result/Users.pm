...
#}
#
#sub add_therapist_role {
#    my ($self) = @_;
#    my $role = $self->roles->find({ name => 'therapist' });
#    $self->add_to_roles({ name => 'therapist' }) unless $role;
#}
#
#sub remove_therapist_role {
#    my ($self) = @_;
#    my $role = $self->roles->find({ name => 'therapist' });
#    $self->remove_from_roles($role) if $role;
#}
